        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
               ...
               <li class="{{ Request::is('home*') ? 'active' : '' }}">
                ...
                @if(Bouncer::can('Create_Branch')) 

                <li class="{{ Request::is('branches*') ? 'active' : '' }}">
                    <a href="{{url('branches')}}"><i class="fa fa-building-o" style="color:#1AB394" aria-hidden="true"></i> <span class="nav-label">Branches</span></a>
                </li>
                @endif
               ...
               <!--  @if(Bouncer::can('Create_Parcel')) 
                ...
                <li class="{{ Request::is('/reports/revenue-chart*') ? 'active' : '' }}">
                    <a href="{{url('/reports/revenue-chart')}}"><i class="fa fa-line-chart" style="color:#1AB394" aria-hidden="true"></i> <span class="nav-label">Reports</span></a>
                </li>
                @endif -->

                @if(Bouncer::can('Create_Payment'))

                     <li class="nav metismenu 
                        @if(Request::is('revenue-chart') || Request::is('report-all-batches*')) active open selected @endif">
                        
                        <a href="#" class="nav-link nav-toggle">
                            <i class="fa fa-area-chart" style="color:#1AB394"></i>
                            <span class="title">Reports</span>
                            <span class="fa arrow"></span>
                        </a>

                        <ul class="nav nav-second-level collapse 
                            @if(Request::is('revenue-chart') || Request::is('report-all-batches*')) in @endif">

                            <li class="{{ Request::is('revenue-chart*') ? 'active' : '' }}">
                                <a href="{{ url('revenue-chart') }}">
                                    <i class="fa fa-line-chart" style="color:#1AB394;"></i> 
                                    <span class="nav-label">Revenue</span>
                                </a>
                            </li>

                            <li class="{{ Request::is('report-all-batches*') ? 'active' : '' }}">
                                <a href="{{ url('report-all-batches') }}">
                                    <i class="fa fa-file-text" style="color:#1AB394;"></i> 
                ...
                @if(Bouncer::can('Create_User')) 
                 ...
                 <li class="nav metismenu 
                    @if(Request::is('users') || Request::is('roles')) active open selected @endif">
                    ...
                    <ul class="nav nav-second-level collapse 
                        @if(Request::is('users') || Request::is('roles')) in @endif">

                        @if(Bouncer::can('Create_Role'))
                            <li class="{{ Request::is('roles*') ? 'active' : '' }}">
                                <a href="{{ url('roles') }}">
                                    <i class="fa fa-diamond" style="color:#1AB394;"></i> 
                ...
                @if(Bouncer::can('Create_User')) 
                 ...
                 <li class="nav metismenu 
                    @if(Request::is('countries') || Request::is('upload-countries*') || Request::is('post-upload-countries*') 
                    || Request::is('statuses') || Request::is('paymentmodes') || Request::is('departments')) active open selected @endif">
                    ...
                    <ul class="nav nav-second-level collapse 
                        @if(Request::is('countries') || Request::is('upload-countries*') || Request::is('post-upload-countries*') 
                        || Request::is('statuses') || Request::is('paymentmodes') || Request::is('departments')) in @endif">

                        @if(Bouncer::can('Create_Country'))
                            <li class="{{ Request::is('countries*') ? 'active' : '' }}">
                                <a href="{{ url('countries') }}">
                                    <i class="fa fa-flag" style="color:#1AB394;"></i> 
                        ...
                        @if(Bouncer::can('Create_Status'))
                            <li class="{{ Request::is('statuses*') ? 'active' : '' }}">
                                <a href="{{ url('statuses') }}">
                                    <i class="fa fa-angle-double-right" style="color:#1AB394;"></i> 
                        ...
                        @if(Bouncer::can('Create_Paymentmode'))
                            <li class="{{ Request::is('paymentmodes*') ? 'active' : '' }}">
                                <a href="{{ url('paymentmodes') }}">
                                    <i class="fa fa-money" style="color:#1AB394;"></i> 
                                    <span class="nav-label">Payment Mode</span>
                                </a>
                            </li>
                        @endif
                        ...
                        @if(Bouncer::can('Create_Department'))
                            <li class="{{ Request::is('departments*') ? 'active' : '' }}">
                                <a href="{{ url('departments') }}">
                                    <i class="fa fa-database" style="color:#1AB394;"></i> 
                ...
                @if(Bouncer::can('Create_LogActivity'))
                       ...
                       <li class="nav metismenu 
                            @if(Request::is('log-activities') || Request::is('monitor')) active open selected @endif">
                            ...
                            <ul class="nav nav-second-level collapse 
                                @if(Request::is('log-activities') || Request::is('monitor')) in @endif">

                                <li class="{{ Request::is('log-activities*') ? 'active' : '' }}">
                                    <a href="{{ route('log-activities.index') }}">
                                        <i class="fa fa-history" style="color:#1AB394;"></i>
                                ...
                                <li class="{{ Request::is('monitor*') ? 'active' : '' }}">
                                    <a href="{{ url('/monitor') }}">
                                        <i class="fa fa-server" style="color:#1AB394;"></i>
