...
<div class="col-lg-10">
    <h2 style="color:#1AB394;"><strong> Department Management | Upload</strong></h2>
    <ol class="breadcrumb">
        <li>
...
<div class="col-lg-12">
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            ...
            {!! Form::open(array('url' => 'post-upload-departments','method'=>'POST','enctype'=>'multipart/form-data')) !!}
                ...
                @if (count($errors) > 0)
                  ...
                  @endif   
                <div class="form-group"> <a href="{{asset('templates/departments.csv')}}"><label class="col-sm-2 control-label">Download template</label></a>
