        ...
        <div class="item active">
            <div class="container">
                ...
                <div class="carousel-image wow zoomIn">
                    <img src="{{asset('inspinia/img/landing/laptop.png')}}" alt="laptop"/>
                </div>
            </div>
...
<section  class="container features">
    ...
    <div class="row">
        ...
        <div class="col-md-6 text-center  wow zoomIn">
            <img src="{{asset('inspinia/img/landing/perspective.png')}}" alt="dashboard" class="img-responsive">
        </div>
    ...
    <div class="row features-block">
        ...
        <div class="col-lg-6 text-right wow fadeInRight">
            <img src="{{asset('inspinia/img/landing/dashboard.png')}}" alt="dashboard" class="img-responsive pull-right">
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-sm-4 wow fadeInLeft">
                <div class="team-member">
                    <img src="{{asset('inspinia/img/landing/avatar3.jpg')}}" class="img-responsive img-circle img-small" alt="">
            ...
            <div class="col-sm-4">
                <div class="team-member wow zoomIn">
                    <img src="{{asset('inspinia/img/landing/avatar1.jpg')}}" class="img-responsive img-circle" alt="">
            ...
            <div class="col-sm-4 wow fadeInRight">
                <div class="team-member">
                    <img src="{{asset('inspinia/img/landing/avatar2.jpg')}}" class="img-responsive img-circle img-small" alt="">
    ...
    <div class="container">
        ...
        <div class="row features-block">
            ...
            <div class="col-lg-6 text-right m-t-n-lg wow zoomIn">
                <img src="{{asset('inspinia/img/landing/iphone.jpg')}}" class="img-responsive" alt="dashboard">
            </div>
    ...
    <div class="container">
        ...
        <div class="row features-block">
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="" class="pull-left">
                        <img alt="image" src="{{asset('inspinia/img/landing/avatar3.jpg')}}">
                    </a>
            ...
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="" class="pull-left">
                        <img alt="image" src="{{asset('inspinia/img/landing/avatar1.jpg')}}">
                    </a>
                    <div class="media-body">
                        <div class="commens-name">
                            Andrew Williams
            ...
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="" class="pull-left">
                        <img alt="image" src="{{asset('inspinia/img/landing/avatar2.jpg')}}">
                    </a>
                    <div class="media-body">
                        <div class="commens-name">
                            Andrew Williams
...
<section id="contact" class="gray-section contact">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 text-center m-t-lg m-b-lg">
                <p><strong>&copy; 2015 Company Name</strong><br/> consectetur adipisicing elit. Aut eaque, laboriosam veritatis, quos non quis ad perspiciatis, totam corporis ea, alias ut unde.|<a href="{{url('login')}}">Login</a></p>
            </div>
        </div>
    </div>
</section>
...
<script src="{{asset('inspinia/js/plugins/wow/wow.min.js')}}ss"></script>
