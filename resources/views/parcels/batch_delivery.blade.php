...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox">
        ...
        <div class="ibox-content">
            ...
            {{-- Filters --}}
            <form method="GET" action="{{ route('parcels.batchDelivery') }}" class="mb-4">
                <div class="row align-items-end">
                    ...
                    <div class="col-md-1 mb-2">
                        <a href="{{ route('parcels.batchDelivery') }}" class="btn btn-secondary btn-sm w-100">
                            ...
                            @foreach($batches as $batch)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ route('parcels.deliveryReceipt', $batch->id) }}" 
